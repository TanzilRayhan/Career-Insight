...
public class UserData extends JFrame {
    ...
    UserData() {
        ...
        // Fonts
        f1 = new Font("Bell MT", Font.PLAIN, 50);
        ...
        label1.setBounds(240, 15, 400, 80);
        label1.setFont(f1);
        c.add(label1);
       ...
       // table.getColumnModel().getColumn(3).setPreferredWidth(220);
        ...
        btn1.setBackground(Color.decode("#5DADE2"));
        c.add(btn1);
        ...
        btn2.setBackground(Color.decode("#E74C3C"));
        c.add(btn2);
        ...
        btn3.setBackground(Color.decode("#2ECC71"));
        c.add(btn3);

        
        btn4 = new JButton("Exit");
        btn4.setBounds(10, 500, 170, 50);
        btn4.setFont(f2);
        ...
        btn5.setBounds(502, 500, 170, 50);;
        btn5.setFont(f2);
        btn5.setFocusable(false);
        btn5.setCursor(cursor);
        btn5.setForeground(Color.WHITE);
        btn5.setBackground(Color.decode("#123456"));
        c.add(btn5);
        ...
        try {
            ...
            for (int i = 0; i < totalLines; i++) {
                ...
                if (x.equals("User")) {
                   ...
                   //rows[3] = Files.readAllLines(Paths.get(file)).get((i + 3)).substring(10); // Date and Time
                    model.addRow(rows);
                }
            }
